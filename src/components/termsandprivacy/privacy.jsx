    ...
    <>
      <main className="w-full max-w-7xl mx-auto px-4 md:px-8 py-10 text-gray-800">
        <div className="text-4xl font-bold mb-8 text-center flex justify-center mt-[10px]">
          <h1 className="text-[#002768]">Privacy</h1>
          <h1 className="text-[#002768]">Policy</h1>
        </div>
        ...
        <section className="mb-10">
          <p className="text-black">
            This privacy statement describes how WebFounders USA collects and uses
            the personal information you provide on our website:
            <Link
              href="https://webfoundersusa.com/"
              className="text-[#002768]"
              target="_blank"
            >
              {" "}
              https://webfoundersusa.com/
            </Link>{" "}
        ...
        <br />
        <section className="text-black">
          <h1 className="text-[#002768] text-3xl mb-4">Choice/Opt-Out</h1>
          <ul>
            <li>
              ...
              <span className="text-[#002768]">contact@webfoundersusa.com</span>
            </li>
            <li>
        ...
        <br />
        <section className="text-black">
          <h1 className="text-[#002768] text-3xl mb-4">
        ...
        <br />
        <section className="text-black">
          <h1 className="text-[#002768] text-3xl mb-4">Information Sharing</h1>
          <ul>
            <li>
              ...
              if WebFounders USA is involved in a merger, acquisition, or sale of all
        ...
        <br />
        <section className="text-black">
          <h1 className="text-[#002768] text-3xl mb-4">Web beacons</h1>
          <ul>
            <li>
        ...
        <section className="text-black">
          ...
          <ul>
            <li>
              ...
              may differ from those of WebFounders USA. If you submit personal
        ...
        <br />
        <section className="text-black">
          <h1 className="text-[#002768] text-3xl mb-4">Security</h1>
          <ul>
            <li>
        ...
        <section className="text-black">
          ...
          <ul>
            ...
            <li>
              ...
              consent to receive SMS text messages from WebFounders USA regarding
