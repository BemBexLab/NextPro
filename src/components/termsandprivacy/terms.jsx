      ...
      <main className="w-full max-w-7xl mx-auto px-4 md:px-8 py-10 text-gray-800">
        ...
        <section className="mb-10">
          <p className="text-black">
            By using WebFounders USA and signing up as a Client, you agree to be
        ...
        <section className="mb-10">
          <p className="text-black">
            ...
            accept these Terms and Conditions, you may not use the WebFounders USA
            service. By placing any order with WebFounders USA you agree to all our
            terms and it is your responsibility to read our terms. WebFounders USA
            ...
            Terms and Conditions, all services provided by and related to WebFounders USA
            and all text, images, photographs, user interface, "look" and
        ...
        <section className="mb-10">
          <p className="text-black">
            You acknowledge and agree that WebFounders USA shall have the right (but
            ...
            acknowledge, consent and agree that WebFounders USA may access,
            ...
            (e) protect the rights, property, or personal safety of WebFounders USA,
        ...
        <section className="mb-10">
          <h2 className="text-3xl font-semibold mb-4 text-[#002768]">
            WebFounders USA General Services
          </h2>
          <ul className="text-black">
            <li>
              Description. WebFounders USA Service is an online service where
              individuals or entities that have signed up with WebFounders USA as
              ...
              experts retained by WebFounders USA ("Members"). WebFounders USA will
            ...
            <li>
              ...
              Creative or Revision Brief. WebFounders USA is under no obligation to
              ...
              clarity. WebFounders USA may decide, in its sole discretion, to deny a
              Creative or Revision Brief or a Term Sheet.
            </li>
            <br />
            <li>
              Reviewing Responses. When WebFounders USA provides you with a Response,
              you are responsible for reviewing the Response. If you fail to
              promptly inform WebFounders USA that the Response is not reasonably
              responsive to the related Term Sheet or Creative Brief, you will
              be deemed to have accepted the Response. If you notify WebFounders USA
              ...
              WebFounders USA with a Revision Brief, WebFounders USA will provide you with
              a subsequent Response that conforms to the additional criteria you
              requested. WebFounders USA is not responsible for the content of
            ...
            <li>
              ...
              completed in a timely manner, however; WebFounders USA reserves the
            ...
            <li>
              ...
              authorized by WebFounders USA. You will be charged for the Package you
              ...
              receipts for all your transactions with WebFounders USA. We hold the
              ...
              not apply to projects submitted before WebFounders USA decides to
        ...
        <section className="mb-10">
          ...
          <ul className="text-black">
            ...
            <li>
              ...
              shall immediately notify WebFounders USA if you learn of or suspect:
              ...
              event of such loss, theft, or unauthorized use, WebFounders USA may
              impose on you, at WebFounders USA's sole discretion, additional
            ...
            <li>
              ...
              of acquisition and shall fully and promptly inform WebFounders USA. You
        ...
        <section>
          ...
          <ul className="text-black">
            <li>
              ...
              "Client Information"), WebFounders USA and its agents shall have all
            ...
            <br />
            <li>
              Rights of WebFounders USA. Upon your submission of Client Information
              to the Service, you grant WebFounders USA a royalty-free, perpetual,
            ...
            <li>
              ...
              provided to you by WebFounders USA (the "Final Product"). You shall
              ...
              WebFounders USA expressly reserves all right, title and interest in
              and to the same. You acknowledge and hereby grant to WebFounders USA a
              ...
              order to display and promote the WebFounders USA Service. WebFounders USA
        ...
        <section>
          ...
          <ul className="text-black">
            <li>
              WebFounders USA intends to use commercially reasonable efforts to
              follow its privacy policy; as such privacy policy may be changed
              from time to time at WebFounders USA's sole discretion. Notwithstanding
              the foregoing, WebFounders USA cannot and does not assume any
              ...
              information accessed by a hacker or by any other malicious party.
            </li>
          </ul>
        </section>
        <br />
        ...
        <section>
          ...
          <ul className="text-black">
            <li>
              ...
              WebFounders USA privacy policy, and complete the registration
              ...
              Conditions. WebFounders USA may accept or reject your registration in
              its sole discretion.
            </li>
            <li>
          ...
          <ul className="text-black">
            ...
            <li>
              ...
              search agents available from WebFounders USA on the Web Site and other
          ...
          <ul className="text-black pl-5">
            ...
            <li>
              ...
              in civil or criminal liability. WebFounders USA will investigate
              ...
              who are involved in such violations. WebFounders USA reserves the right
              ...
              Site at any time without notice, in its sole discretion. WebFounders USA
              will use commercially reasonable efforts not to disclose any
          ...
          <ul className="text-black">
            <li>
              (h) Operation of Web Site. WebFounders USA shall not be responsible for
              any delays or interruptions of, or errors or omissions contained
              in, the Web Site. WebFounders USA reserves the right, but shall not be
              required, to correct any such delays, interruptions, errors or
              omissions. Although WebFounders USA intends to use commercially
              reasonable efforts to make the Web Site and Service accessible,
              WebFounders USA makes no representation, warranty or covenant that the
              ...
              telecommunications and/or server problems. WebFounders USA may at any
              ...
              speeds or other signal characteristics. WebFounders USA shall not be
        ...
        <section>
          ...
          <ul className="text-black">
            <li>
              By using the WebFounders USA Service, you agree to receive, via email
              ...
              to you at any time. WebFounders USA may or may not use a third party to
              send email or otherwise contact you, however, your personal
              identifying information will never be disclosed or shared with
              another party in a manner inconsistent with WebFounders USA's
              privacy policy.
            </li>
            <br />
            <li>
              By providing a telephone number and submitting this form, you
              consent to receive SMS text messages from WebFounders USA LLC regarding
              ...
              assistance or call
              <span className="text-[#002768]">+1 (470) 470-7392</span>. Please
        ...
        <section>
          ...
          <ul className="text-black">
            <li>
              Responsibility for Content. WebFounders USA shall not be responsible
              for any use that is or is not made of the Web Site or the Service.
              Without limiting the foregoing, WebFounders USA makes no
              ...
              Members, Clients, WebFounders USA or otherwise, nor does WebFounders USA
              endorse any opinions expressed by any user of the Web Site,
              including any Member or Client. Without limiting the foregoing,
              WebFounders USA makes no representations, warranties or covenants
              ...
              Images: WebFounders USA shall not be responsible for any use of photos
              ...
              WebFounders USA for the client. This includes websites, website
