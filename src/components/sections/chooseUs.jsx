                    ...
                    <div>
                        <SlideUp>
                            <div>
                                ...
                                <p className='pt-7.5 font-semibold'>At Next Agency, we understand that choosing the right partner for your digital marketing needs is crucial. Here's why we believe we should be your first choice:</p>
                            </div>
                        </SlideUp>
