...
import team_icon from "../../../public/images/shapes/Frame 210.webp";
import skills_icon from "../../../public/images/shapes/Frame 209.webp";
import content_icon from "../../../public/images/shapes/Frame 208.webp";
          ...
          <div className="after:absolute after:left-0 after:top-0 after:w-full after:h-full after:bg-gray after:rounded-[30px] after:z-[-1] relative flex items-center justify-center min-h-[300px] px-3 lg:px-0 bg-gray-200 rounded-[30px]">
            <div className="flex lg:flex-row flex-col gap-8 justify-center lg:items-center items-start max-w-[1320px] w-full py-12.5">
              ...
              <Card
                ...
                isIcon={false}
                desc={`
                  <p> <span class='font-semibold'>Email:</span> <a href="mailto:contact@webfoundersusa.com" class='relative hover-underline after:h-[1px] after:bg-muted'> contact@webfoundersusa.com</a> </p>
                  <p> <span class='font-semibold'>Call us:</span> <a href="tel:+14704707392" class='relative hover-underline after:h-[1px] after:bg-muted'> +1 470-470-7392 </a> </p>
                `}
              />
              <Card
                icon={content_icon}
