            ...
            <div className='flex md:flex-row flex-col justify-between gap-8'>
                ...
                <div className='flex items-center gap-8'>
                    ...
                    <div className={cn(`${color}`)}>
                        ...
                        <p> <span className='font-semibold'>Call us:</span> <Link href={"tal:+14702005121"} className='relative hover-underline after:h-[1px] after:bg-muted'>+1 (470) 200-5121</Link> </p>
                    </div>
                </div>
            </div>
        </div>
