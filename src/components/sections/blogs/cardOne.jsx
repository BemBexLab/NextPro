            ...
            <ZoomIn id={id}>
                ...
                <div className='pt-[15px]'>
                    <div className='flex items-center gap-7.5 pb-[15px]'>
                        <Link key={id} href={`/blog/top-usa-digital-marketing-agencies-in-2026`} className='text-base font-semibold hover:text-primary-foreground transition-all duration-500'> {author.author_name}</Link>
                    ...
                    <Title size={"2xl"}>
                        <Link key={id} href={`/blog/top-usa-digital-marketing-agencies-in-2026`} className='multiline-hover hover:text-primary-foreground transition-all duration-500'>{title}</Link>
                    </Title>
                </div>
            </ZoomIn>
        </div>
