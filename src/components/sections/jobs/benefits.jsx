                ...
                <div className='bg-[rgba(46,77,254,0.05)] rounded-[30px] px-[25px] py-[43px]'>
                    ...
                    <ul className='pt-5 flex flex-col gap-[15px]'>
                        <li className='flex items-start gap-2'>
                            <Image src={"/images/shapes/job-feature-icon1-1.webp"} width={18} height={17} alt='icon' />
                            <span className='text-base inline-block -mt-1'>Competitive salary commensurate with experience.</span>
                        </li>
                        <li className='flex items-start gap-2'>
                            <Image src={"/images/shapes/job-feature-icon1-2.webp"} width={18} height={17} alt='icon' />
                        ...
                        <li className='flex items-start gap-2'>
                            <Image src={"/images/shapes/job-feature-icon1-3.webp"} width={18} height={17} alt='icon' />
                            <span className='text-base inline-block -mt-1'>Flexible work schedule and remote work options.</span>
                        </li>
                        <li className='flex items-start gap-2'>
                            <Image src={"/images/shapes/job-feature-icon1-4.webp"} width={18} height={17} alt='icon' />
                        ...
                        <li className='flex items-start gap-2'>
                            <Image src={"/images/shapes/job-feature-icon1-5.webp"} width={18} height={17} alt='icon' />
                        ...
                        <li className='flex items-start gap-2'>
                            <Image src={"/images/shapes/job-feature-icon1-6.webp"} width={18} height={17} alt='icon' />
                            <span className='text-base inline-block -mt-1'>Dynamic and collaborative work environment with a focus on creativity and innovation.</span>
                        </li>
                    </ul>
                </div>
