...
const buttonVariants = cva(
  "inline-flex items-center gap-2.5 justify-center max-h-[52px] whitespace-nowrap text-lg font-bold ring-offset-background border-2 border-[#BF0B30] transition-colors transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-[#BF0B30] text-secondary-foreground dark:text-muted-foreground rounded-lg border-2 border-[#BF0B30] transition-all duration-300 ease-in-out hover:bg-transparent hover:text-[#BF0B30] hover:scale-105 hover:shadow-xl hover:border-[#BF0B30] focus:outline-none focus:ring-4 focus:ring-[#BF0B30]/30",
        ...
        secondary:
          "bg-[#E2E7FF] text-primary rounded-lg rounded-[40px] border-transparent max-h-[43px]",
