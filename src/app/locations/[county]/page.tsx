...
import { countyPosts, getCountyPostBySlug } from "@/data/county";
...
export async function generateMetadata({
  ...
  const metaDescription = post.metaDescription?.trim() || post.description;
    ...
    <section className="overflow-hidden bg-white">
      ...
      <article className="mx-auto max-w-[980px] px-4 py-10 sm:px-6 sm:py-16 lg:px-8 lg:py-20">
        ...
        <p className="mt-5 italic text-sm text-[#8b8b8b] sm:text-base">
          By Web Founders USA | {post.publishedAt}
        </p>
