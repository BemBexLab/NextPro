...
const LocalSEOServices = () => {
  const services = [
    ...
    },
    {
      ...
      description:
        (<>We do a thorough check of your site through <a href="/service/seo-services/seo-audit/" className="hover:text-blue-800 hover:underline" target="_blank" rel="noopener noreferrer">SEO audit services</a> to find things that are keeping it from ranking, missed chances, and gaps in your competitors' sites. Then we turn that information into an action plan that also helps with enterprise SEO services.</>),
    },
    {
