...
export default function BlogSlugPage() {
  ...
  useEffect(() => {
    ...
    let link = document.querySelector(
      'link[rel="canonical"][data-wp-blog="true"]'
    ) as HTMLLinkElement | null;

    if (!link) {
      link = document.createElement("link");
      link.rel = "canonical";
      link.dataset.wpBlog = "true";
  ...
  }, [post?.link, post?.yoast_head_json?.canonical]);
